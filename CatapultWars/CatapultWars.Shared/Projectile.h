...
namespace CatapultWars {
	...
	public:
		...
		Projectile(std::shared_ptr<DirectX::SpriteBatch>& spriteBatch, std::vector<std::shared_ptr<Projectile>>& activeProjectiles, std::wstring textureName, DirectX::SimpleMath::Vector2 startPosition, float groundHitOffset, bool isRightPlayer, float gravity);
		...
		bool												HitHandled;
		float												Wind;
		std::shared_ptr<Animation>							HitAnimation;
